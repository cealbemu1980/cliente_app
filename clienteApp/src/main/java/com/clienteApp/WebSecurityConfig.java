...
import com.clienteApp.util.loginSuccessMessage;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/home","/", "/css/**", "/js/**", "/images/**").permitAll()
				 ...
				 * .antMatchers("/views/clientes/save").hasAnyRole("USER")
				 * .antMatchers("/views/clientes/editar/**").hasAnyRole("ADMIN")
				 * .antMatchers("/views/clientes/editar/**").hasAnyRole("USER")
				 * .antMatchers("/views/clientes/eliminar/**").hasAnyRole("ADMIN")
				 */
